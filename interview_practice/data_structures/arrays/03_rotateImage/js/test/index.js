  ...
  const tests = [
    {
      ...
      ins_and_outs: [
        {
          ...
          cxt: 'with an array.array of a single integer as input, the input should be the output',
          in: [
            [
              [1]
            ]
      ...
      run: param => {
        ...
        it(cxt, () => {
          ...
          param.out.forEach((row, rowIdx) => row.forEach((testCol, testColIdx) => {
            expect(result[rowIdx][testColIdx]).to.deep.equal(testCol);
          }))
        });
      }
    }/*, {
